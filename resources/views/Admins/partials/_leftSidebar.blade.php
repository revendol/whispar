        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('admin/campaigns') }}"><i class="fa fa-circle-o"></i> Campaign</a></li>
                    <li><a href="{{ url('admin/templates') }}"><i class="fa fa-circle-o"></i> Template</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-check"></i> <span>Wispar core</span>
                </a>
            </li>
            {{--<li class="treeview">--}}
                {{--<a href="#">--}}
